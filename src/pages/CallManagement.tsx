          ...
          <div className="text-center my-20">
            ...
            <p className="text-base text-white mb-12 max-w-4xl mx-auto leading-relaxed">
             ...
             <div className="flex flex-row items-center justify-center gap-6">
              ...
              <a
                href={callManagementHero.primaryCta.href} target="_blank" rel="noopener noreferrer"
              ...
              <a href={callManagementHero.secondaryCta.href} className="text-purple-400 hover:text-purple-500 font-bold text-base transition-colors duration-300">
