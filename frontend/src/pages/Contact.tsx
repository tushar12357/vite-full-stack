              ...
              {LOCATIONS.map((location) => {
                ...
                return (
                  <button
                    ...
                    className={`rounded-2xl p-6 flex flex-col items-center text-center transition-all border bg-[#0D0D0D] ${isActive
        ...
        <section className="bg-black py-20 md:py-32 px-4 md:px-12 lg:px-16 xl:px-24">
          <div className="max-w-6xl mx-auto">
            <div className="bg-[#0F0F0F] border border-white/10 rounded-[32px] p-8 md:p-12 lg:p-16">
              ...
              <Link to="/contact" className="mt-8 inline-flex items-center justify-center bg-gradient-to-r from-[#7C3AED] to-[#A855F7] text-white text-base font-semibold px-8 py-3 rounded-full shadow-[0_10px_30px_rgba(124,58,237,0.35)] hover:scale-[1.01] transition-transform">
                Get In Touch
              </Link>
            </div>
          </div>
