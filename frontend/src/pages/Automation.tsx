          ...
          <div className="text-center my-20">
            ...
            <p className="text-base text-white mb-12 max-w-4xl mx-auto leading-relaxed">
             ...
             <div className="flex flex-row items-center justify-center gap-6">
              ...
              <a
                href={workflowHero.primaryCta.href}
              ...
              <a href={workflowHero.secondaryCta.href} className="text-purple-400 hover:text-purple-500 font-bold text-base transition-colors duration-300">
