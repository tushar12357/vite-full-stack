        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center my-20">
            ...
            <div className="flex flex-row items-center justify-center gap-6">
              ...
              <a href="/contact" target="_blank" rel="noopener noreferrer" className="px-8 py-4 bg-purple-600 hover:bg-purple-700 text-white font-bold text-base rounded-full transition-all duration-300 hover:shadow-lg hover:scale-105">
                Talk To Sales
              </a>
