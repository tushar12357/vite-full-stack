...
const CriteriaCard = ({ title, description }: CriteriaCardProps) => {
  return (
    <div className="bg-black border border-gray-900 rounded-xl p-4 hover:border-gray-800 transition-all h-full flex flex-col">
      ...
      <p className="text-xs text-white/90 text-center leading-relaxed flex-1">{description}</p>
    </div>
  );
};
