    ...
    <section className="py-20 bg-black">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-left mb-16">
          ...
          {/* Main Heading */}
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 text-white">{title}</h2>
          
          {/* Description */}
          <p className="text-base md:text-lg text-gray-400 max-w-3xl">{subtitle}</p>
        </div>

        {/* Steps Grid - 2 rows x 3 columns */}
        <div className="grid md:grid-cols-2 lg:grid-cols-3 border border-gray-800 rounded-xl overflow-hidden">
          {steps.map((step, idx) => {
            ...
            <div 
              key={idx} 
              className={`
                bg-black p-6 hover:bg-gray-900 transition-all
            ...
            >
              ...
              <div className="flex justify-center mb-4">
                <div className="w-14 h-14 rounded-lg bg-gray-800 border border-gray-700 mb-10 flex items-center justify-center">
              ...
              {/* Description */}
              <p className="text-sm mb-10 text-gray-400 leading-relaxed text-center">{step.description}</p>
            </div>
            );
          })}
        </div>
